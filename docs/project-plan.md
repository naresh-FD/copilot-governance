...
| 5 | Prompt Interception Kernel | In progress (shadow mode) | Every prompt is rewritten against the governance core before the model sees it, and every interception is measured. See `docs/prompt-interception-plan.md`. |
...
| Metric | Target |
| --- | --- |
| Repo onboarding | 100% active repos covered |
