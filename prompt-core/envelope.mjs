...
export function createCanonicalEnvelope({
  ...
  const envelope = {
    ...
    policySignatureKeyId: policyPack.manifest.signature?.keyId || null,
    ...
    selectedWorkflowIds: [],
    routingResult: "evaluation_pending",
    policyResults: [],
...
export function telemetryFromEnvelope(envelope, decision) {
  return {
    ...
    policySignatureKeyId: envelope.policySignatureKeyId,
    ...
    routingResult: envelope.routingResult,
    ...
    enforcementLevel: decision.enforcementLevel || null,
